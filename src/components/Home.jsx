...
const Home = () => {
  return (
    <section
      id="home"
      className="min-h-[50rem] w-full relative flex flex-col sm:flex-row items-center   sm:justify-between text-light px-[10%]"
    >
      <Navbar />
      <video
        src={bgVideo4}
      ...
      <div className="lg:pl-0 z-10 font-sourceCode font-semibold flex flex-col">
        ...
        <button className="sm:max-w-1/2 py-4 px-12 bg-accent font-[800] text-black rounded-lg text-lg sm:text-2xl font-sourceCode h-full my-6 tilt-hover">
          Contact
        </button>
      </div>
      <div className="w-[40%] sm:w-[20%] lg:w-[25%] relative overflow-hidden bg-accent rounded-t-[1rem] border-2 border-black shadow-xl tilt-hover">
